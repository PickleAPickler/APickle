...
### Yo!
### Issues:
# Game commences even if P2 says 'no' to 'are you ready to play' 
# Will testing/debugging tools help if I wanted to select a player? Go back steps in the game logic, go forward etc...Think yes. 
# ...what do I need to understand? Maybe ask in Codecademy. 
